                ...
                <div className="row row--grid">
                    ...
                    <div className="col-12 col-xl-11">
                        <div className="main__title main__title--page">
                            <h1>token – NFT Marketplace HTML Template</h1>

                            <p>Many desktop publishing packages and <button>web page</button> editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).</p>
                ...
                <div className="row row--grid">
                    <div className="col-12 col-lg-4">
                        <div className="step">
                            ...
                            <p className="step__text">It to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining</p>
                        </div>
                    </div>
                    ...
                    <div className="col-12 col-lg-4">
                        <div className="step">
                            ...
                            <p className="step__text">All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first</p>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="col-12 col-lg-8 col-xl-8">
                            <div className="main__title">
                                ...
                                <p>All the Lorem Ipsum generators on the <b>Internet</b> tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable.</p>

                                <p>Many desktop publishing packages and <button>web page</button> editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy.</p>

                                <button href="https://vimeo.com/45830194" className="main__video open-video">Watch video</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="row row--grid">
                    ...
                    <div className="col-12 col-md-6 col-lg-4 col-xl-3">
                        <div className="feature">
                            ...
                            <h3 className="feature__title">Get airdrop <br />as token user</h3>
                            <p className="feature__text">It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially</p>
                        </div>
                    </div>
                    ...
                    <div className="col-12 col-md-6 col-lg-4 col-xl-3">
                        <div className="feature">
                            ...
                            <h3 className="feature__title">Hustle in token DAO</h3>
                            <p className="feature__text">It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially</p>
                        </div>
                    </div>
                    ...
                    <div className="col-12 col-md-6 col-lg-4 col-xl-3">
                        <div className="feature feature--last">
                            ...
                            <h3 className="feature__title">Participate <br />in moderation</h3>
                            <p className="feature__text">If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing</p>
                        </div>
                    </div>
                </div>
            </div>
