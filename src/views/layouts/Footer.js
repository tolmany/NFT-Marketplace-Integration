                ...
                <div className="row">
                    <div className="col-12 col-sm-8 col-md-6 col-lg-6 col-xl-4 order-4 order-md-1 order-lg-4 order-xl-1">
                        ...
                        <div className="footer__lang">
                            <Link to="#" className="footer__lang-btn" role="button" id="dropdownLang" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img src="img/flags/uk.svg" alt="" />
                                <span>English</span>
                            </Link>

                            <ul className="dropdown-menu footer__lang-dropdown" aria-labelledby="dropdownLang">
                                <li><Link to="#"><img src="img/flags/spain.svg" alt="" /><span>Spanish</span></Link></li>
                                <li><Link to="#"><img src="img/flags/russia.svg" alt="" /><span>Russian</span></Link></li>
                                <li><Link to="#"><img src="img/flags/china.svg" alt="" /><span>Chinese</span></Link></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="col-12">
                        <div className="footer__content">
                            <div className="footer__social">
                                ...
                                <Link to="#" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M19,4H5A3,3,0,0,0,2,7V17a3,3,0,0,0,3,3H19a3,3,0,0,0,3-3V7A3,3,0,0,0,19,4Zm-.41,2-5.88,5.88a1,1,0,0,1-1.42,0L5.41,6ZM20,17a1,1,0,0,1-1,1H5a1,1,0,0,1-1-1V7.41l5.88,5.88a3,3,0,0,0,4.24,0L20,7.41Z"/></svg></Link>
                            </div>

                            <small className="footer__copyright">© Unitok, 2021. Created by <Link to="https://themeforest.net/user/dmitryvolkov/portfolio" target="_blank">Dmitry Volkov</Link>.</small>
                        </div>
                    </div>
                </div>
            </div>
