                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="hero owl-carousel" id="hero">
                                <div className="hero__slide" data-bg="img/home/home.png">
                                ...
                                <div className="hero__slide" data-bg="img/home/home.png">
                                    <h2 className="hero__title">Rd – NFT Marketplace <br />HTML Template</h2>
                            ...
                            <div className="main__carousel main__carousel--live owl-carousel" id="live">
                                ...
                                <div className="card">
                                    <Link to="/item" className="card__cover card__cover--video">
                                        <img src="img/cover/cover4.png" alt="" />
                ...
                <div className="row row--grid">
                    ...
                    <div className="col-12 col-md-6 col-lg-4 col-xl-3">
                        <div className="feature">
                            ...
                            <p className="feature__text">Once you’ve set up your wallet of choice, connect it to NFT marketplace by clicking this link. <br /><Link to="/">Connect my wallet</Link>.</p>
                        </div>
                    </div>
